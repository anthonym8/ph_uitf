...
<br />
The risk flavors for each fund classification above is not fixed. These are the typical labels used by banks when marketing their UITF products. The graph below shows how each fund category is labelled by risk flavor according to banks.
...
plot <- fund_performance %>% 
    mutate(tooltip = paste(Name,
                           paste("Symbol:", Symbol),
                           paste("Bank:", Bank),
                           paste("Category:", `Fund Classification`),
                           paste0("YOY Return: ", 
